...
- (void)initializeViews {
    ...
    [_listCollectionView setBackgroundColor:[UIColor clearColor]];
...
- (void)listDidScroll:(UIScrollView *)scrollView {
    // 主列表滑动
    if ([self.delegate respondsToSelector:@selector(mainScrollviewDidscroll:)]) {
        [self.delegate mainScrollviewDidscroll:scrollView];
    }
