...
@interface KKPubTagVC ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
-(void)setUpView{
    ...
    [self.collectionView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.bottom.mas_equalTo(self.releaseButtonBgView.mas_top).offset(-15);
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    KKPubTagVCDataModel *selecteModel = [KKPubTagVCModel shareToolGetManager].tagArr[indexPath.row];
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.titleLabel.text =[NSString stringWithFormat:@"#%@",[KKPubTagVCModel shareToolGetManager].tagArr[indexPath.row].title];
...
- (NSInteger)collectionView:(UICollectionView *)collectionView numberOfItemsInSection:(NSInteger)section {
    return [KKPubTagVCModel shareToolGetManager].tagArr.count;
}
...
//    KKPubTagVCDataModel *model = self.tagDataArray[indexPath.row];
    NSString *text = [KKPubTagVCModel shareToolGetManager].tagArr[indexPath.row].title;
