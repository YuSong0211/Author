...
@property (nonatomic,strong) NSMutableArray <UITapGestureRecognizer *>*tapArray;

//是否是发布预览场景
@property (nonatomic,assign) BOOL isPublishPreview;
...
@property (nonatomic,strong)NSMutableArray *PictureThumbnailsArray;
...
/**
 ...
 @return 返回当前对象
 */
- (instancetype)showImageWithWebItems:(NSArray <LBPhotoWebItem *> *)items selectedIndex:(NSInteger)index fromImageViewSuperView:(UIView *)superView withEasyArr:(NSMutableArray *)arr;
