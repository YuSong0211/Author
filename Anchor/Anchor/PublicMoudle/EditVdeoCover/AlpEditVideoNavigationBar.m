...
//    self.alpha = .8;
    ...
    _titleLabel.font = [UIFont mediumWithSize:16];
    _titleLabel = titleLabel;
    titleLabel.textColor = [KKColor getColor:appMainTextColor];
    ...
    [nextBtn setTitleColor:[KKColor getColor:appMainTextColor] forState:UIControlStateNormal];
