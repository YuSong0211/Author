...
@interface KTVHCDownload () <NSURLSessionDataDelegate, NSLocking,NSURLSessionDelegate>
...
- (void)URLSession:(NSURLSession *)session didReceiveChallenge:(NSURLAuthenticationChallenge *)challenge completionHandler:(void (^)(NSURLSessionAuthChallengeDisposition, NSURLCredential * __nullable credential))completionHandler
{
...
//           NSString *p12 = [[NSBundle mainBundle] pathForResource:@"client"ofType:@"p12"];
           NSURLCredential *credential = [KKTool myUrlCredential];
       ...
       else if ([challenge.protectionSpace.authenticationMethod isEqualToString:NSURLAuthenticationMethodServerTrust])//Server Authentication
       {
           ...
           NSData *localData = [NSData dataWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"client" ofType:@"cer"]];
