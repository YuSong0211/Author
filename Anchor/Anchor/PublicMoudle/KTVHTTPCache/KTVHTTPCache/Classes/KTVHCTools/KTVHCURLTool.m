...
{
    NSString *namestr = [KKTool stringInterceptionConversion:URL.absoluteString];
    
    if (self.URLConverter && namestr.length > 0) {
        NSURL *newURL = self.URLConverter([NSURL URLWithString:namestr]);
