...
@interface appvapiUserContentSocialApilistFollowedVideosAppendIdEncode : GProtoBufferMessage
    ...
    //定义pb返回结构
    @property(strong,nonatomic) appvapiContentSvideoAppendList*  respose;
