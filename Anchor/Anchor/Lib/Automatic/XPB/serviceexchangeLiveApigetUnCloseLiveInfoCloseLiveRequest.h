...
@interface serviceexchangeLiveApigetUnCloseLiveInfoCloseLiveRequest : GProtoBufferMessage
    ...
    //定义pb返回结构
    @property(strong,nonatomic) serviceexchangeGetUnCloseLiveInfoResponse*  respose;
