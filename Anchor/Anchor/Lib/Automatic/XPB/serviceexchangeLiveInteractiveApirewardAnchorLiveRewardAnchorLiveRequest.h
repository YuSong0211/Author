...
@interface serviceexchangeLiveInteractiveApirewardAnchorLiveRewardAnchorLiveRequest : GProtoBufferMessage

    //创建pb对象,构建数据
    +(serviceexchangeLiveInteractiveApirewardAnchorLiveRewardAnchorLiveRequest*)createRequest;

    //定义pb请求结构
    @property(strong,nonatomic) serviceexchangeRewardAnchorLiveRequest*  request;
