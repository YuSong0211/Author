...
@interface serviceexchangeLiveApiexitLiveRoomExitLiveRoomRequest : GProtoBufferMessage

    //创建pb对象,构建数据
    +(serviceexchangeLiveApiexitLiveRoomExitLiveRoomRequest*)createRequest;

    //定义pb请求结构
    @property(strong,nonatomic) serviceexchangeExitLiveRoomRequest*  request;
