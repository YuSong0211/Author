...
@interface serviceexchangeLiveInteractiveApiliveChatLiveChatRequest : GProtoBufferMessage

    //创建pb对象,构建数据
    +(serviceexchangeLiveInteractiveApiliveChatLiveChatRequest*)createRequest;

    //定义pb请求结构
    @property(strong,nonatomic) serviceexchangeLiveChatRequest*  request;
