...
@interface appvapiCustomerServiceApilistAllCategoriesAndQuestionEmptyRequest : GProtoBufferMessage
    ...
    //定义pb返回结构
    @property(strong,nonatomic) appvapiListAllQuestionGroupByCategoryResponse*  respose;
