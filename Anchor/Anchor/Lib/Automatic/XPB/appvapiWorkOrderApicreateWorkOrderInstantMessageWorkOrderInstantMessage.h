...
@interface appvapiWorkOrderApicreateWorkOrderInstantMessageWorkOrderInstantMessage : GProtoBufferMessage

    //创建pb对象,构建数据
    +(appvapiWorkOrderApicreateWorkOrderInstantMessageWorkOrderInstantMessage*)createRequest;

    //定义pb请求结构
    @property(strong,nonatomic) appvapiWorkOrderInstantMessage*  request;
