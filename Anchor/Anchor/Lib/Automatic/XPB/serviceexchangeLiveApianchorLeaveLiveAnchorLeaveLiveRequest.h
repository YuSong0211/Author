...
@interface serviceexchangeLiveApianchorLeaveLiveAnchorLeaveLiveRequest : GProtoBufferMessage

    //创建pb对象,构建数据
    +(serviceexchangeLiveApianchorLeaveLiveAnchorLeaveLiveRequest*)createRequest;

    //定义pb请求结构
    @property(strong,nonatomic) serviceexchangeAnchorLeaveLiveRequest*  request;
