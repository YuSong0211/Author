...
- (void)viewDidLoad {
    ...
    self.navigationBar.barTintColor = KKRGBA(20, 21, 27, 1);
    self.navigationBar.tintColor = KKRGBA(20, 21, 27, 1);
...
- (void)configNavigationBarAppearance {
    if (@available(iOS 13.0, *)) {
        ...
        if (self.navigationBar.isTranslucent) {
            ...
            barAppearance.backgroundColor = KKRGBA(20, 21, 27, 1);
        } else {
            barAppearance.backgroundColor = KKRGBA(20, 21, 27, 1);
        }
        ...
        [[TZImageManager manager] getAllAlbumsWithFetchAssets:!self.isFirstAppear completion:^(NSArray<TZAlbumModel *> *models) {
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                if (!self->_tableView) {
                    ...
                    self->_tableView.separatorStyle = UITableViewCellAccessoryNone;
